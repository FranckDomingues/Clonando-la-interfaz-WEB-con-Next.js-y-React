...
const popularListings: Listing[] = [
  { id: "orlando-1", image: "🏡", title: "Alojamiento en Orlando", price: "$244", pricingQualifier: "por 2 noches", rating: "4.9", categoryId: "stays", guestFavorite: true },
  { id: "orlando-2", image: "🌴", title: "Casa cerca de Orlando", price: "$227", pricingQualifier: "por 2 noches", rating: "4.8", categoryId: "stays" },
  { id: "orlando-3", image: "🏨", title: "Habitación en Orlando", price: "$198", pricingQualifier: "por 2 noches", rating: "4.7", categoryId: "stays" },
];

const hotelListings: Listing[] = [
  { id: "hotel-1", image: "🏨", title: "Hotel en el centro", price: "$216", pricingQualifier: "por 2 noches", rating: "4.8", categoryId: "stays", guestFavorite: true },
  { id: "hotel-2", image: "🌆", title: "Hotel excelente", price: "$238", pricingQualifier: "por 2 noches", rating: "4.9", categoryId: "stays" },
  { id: "hotel-3", image: "🛏️", title: "Habitación de hotel", price: "$205", pricingQualifier: "por 2 noches", rating: "4.6", categoryId: "stays" },
];
...
const Home = () => {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl bg-white px-5 pb-8 pt-5 text-neutral-900 md:px-10 md:pt-8">
      <MobileSearch value={searchQuery} onChange={setSearchQuery} />
